...
echo "product-grids.blade.php fully restored and perfected.\n";

// Fix index.blade.php CSS flex-direction bug
$indexFile = 'resources/views/frontend/index.blade.php';
$indexContent = file_get_contents($indexFile);
$indexContent = preg_replace('/\.single-product \.product-action,.*?flex-direction: column !important;.*?}/s', '', $indexContent);
$indexContent = str_replace('flex-direction: column !important;', '', $indexContent);
$indexContent = str_replace('flex-direction: column;', '', $indexContent);
$indexContent = preg_replace('/\.single-product \.product-action \{.*?float: none !important;\s*\}/s', "
...
echo "index.blade.php buttons flex-direction fixed.\n";
