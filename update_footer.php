...
// Using PHP's HEREDOC, variables starting with $ need escaping if we don't want them parsed.
// I have escaped \$settings above.

file_put_contents($file, $newFooter);
echo "Footer updated completely.\n";
