...
$content = str_replace('Auth()->user()->photo', 'Auth()->check() ? Auth()->user()->photo : null', $content);
$content = str_replace('exit();', 'return response()->json(["status"=>"success"]);', $content);
file_put_contents($file, $content);
echo "MessageController fixed.\n";

$blade = 'resources/views/frontend/pages/contact.blade.php';
$bladeContent = <<<'BLADE'
                    ...
                    <div class="contact-info-panel" style="padding: 50px 40px; height: 100%;">
                        ...
                        <div class="info-item" style="display: flex; margin-bottom: 30px;">
                            ...
                            <div class="text">
                                ...
                                <p style="color: rgba(255,255,255,0.8); font-size: 15px;">@foreach($settings as $data) {{$data->address}} @endforeach</p>
                            </div>
                        </div>
                        ...
                        <div class="info-item" style="display: flex; margin-bottom: 30px;">
                            ...
                            <div class="text">
                                ...
                                <p style="color: rgba(255,255,255,0.8); font-size: 15px;">@foreach($settings as $data) {{$data->phone}} @endforeach</p>
                            </div>
                        </div>
                        ...
                        <div class="info-item" style="display: flex;">
                            ...
                            <div class="text">
                                ...
                                <p style="color: rgba(255,255,255,0.8); font-size: 15px;">@foreach($settings as $data) {{$data->email}} @endforeach</p>
                            </div>
                        </div>
                    </div>
                </div>
